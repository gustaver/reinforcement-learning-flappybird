        ...
        while mainloop:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_SPACE and self.cur_item == 0:
                        game.startTrain()
                    if event.key == pygame.K_SPACE and self.cur_item == 1:
                        game.startPlay()
                    if event.key == pygame.K_SPACE and self.cur_item == 2:
                        game.quit()
